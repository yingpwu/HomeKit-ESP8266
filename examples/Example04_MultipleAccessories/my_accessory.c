...
homekit_characteristic_t cha_temperature =
    HOMEKIT_CHARACTERISTIC_(CURRENT_TEMPERATURE, 1);

// format: float; min 0, max 100, step 1
homekit_characteristic_t cha_humidity =
    HOMEKIT_CHARACTERISTIC_(CURRENT_RELATIVE_HUMIDITY, 1);

// format: float; min 0.0001, max 100000
homekit_characteristic_t cha_light =
    HOMEKIT_CHARACTERISTIC_(CURRENT_AMBIENT_LIGHT_LEVEL, 1);

// format: uint8; 0 ”Contact is detected”, 1 ”Contact is not detected”
homekit_characteristic_t cha_contact =
    HOMEKIT_CHARACTERISTIC_(CONTACT_SENSOR_STATE, 0);

// format: bool;
homekit_characteristic_t cha_motion =
    HOMEKIT_CHARACTERISTIC_(MOTION_DETECTED, false);

// format: uint8; 0 ”Occupancy is not detected”, 1 ”Occupancy is detected”
homekit_characteristic_t cha_occupancy =
...
homekit_accessory_t *accessories[] = {
    HOMEKIT_ACCESSORY(
            ...
            .services =
                (homekit_service_t *[]){
                    // HAP section 8.17:
                    // For a bridge accessory, only the primary HAP accessory
                    // object must contain this(INFORMATION) service.
                    // But in my test,
                    // the bridged accessories must contain an INFORMATION
                    // service,
                    ...
                    HOMEKIT_SERVICE(
                        ...
                        .characteristics =
                            (homekit_characteristic_t *[]){
                                ...
                                NULL}),
                    NULL}),
    HOMEKIT_ACCESSORY(.id = 2,
                      .category = homekit_accessory_category_target_controller,
                      .services =
                          (homekit_service_t *[]){
                              HOMEKIT_SERVICE(
                                  ACCESSORY_INFORMATION,
                                  .characteristics =
                                      (homekit_characteristic_t *[]){
                                          ...
                                          HOMEKIT_CHARACTERISTIC(
                                              IDENTIFY, my_accessory_identify),
                                          NULL}),
                              HOMEKIT_SERVICE(
                    ...
                    HOMEKIT_SERVICE(
                        ...
                        .characteristics =
                            (homekit_characteristic_t *[]){
                                ...
                                NULL}),
                    HOMEKIT_SERVICE(
                        HUMIDITY_SENSOR, .primary = true,
                        .characteristics =
                            (homekit_characteristic_t *[]){
                                HOMEKIT_CHARACTERISTIC(NAME, "Humidity"),
                                &cha_humidity, NULL}),
                    NULL}),
    HOMEKIT_ACCESSORY(.id = 4, .category = homekit_accessory_category_sensor,
                      .services =
                          (homekit_service_t *[]){
                              HOMEKIT_SERVICE(
                                  ACCESSORY_INFORMATION,
                              ...
                              NULL}),
    HOMEKIT_ACCESSORY(
            .id = 5, .category = homekit_accessory_category_sensor,
            .services =
                (homekit_service_t *[]){
                    HOMEKIT_SERVICE(
                        ACCESSORY_INFORMATION,
                    ...
                    NULL}),
    HOMEKIT_ACCESSORY(
            .id = 6, .category = homekit_accessory_category_sensor,
            .services =
                (homekit_service_t *[]){
                    HOMEKIT_SERVICE(
                        ACCESSORY_INFORMATION,
                        .characteristics =
                            (homekit_characteristic_t *[]){
                                ...
                                NULL}),
                    HOMEKIT_SERVICE(
                        MOTION_SENSOR, .primary = true,
                        .characteristics =
                            (homekit_characteristic_t *[]){
                                HOMEKIT_CHARACTERISTIC(NAME, "Motion"),
                                &cha_motion, NULL}),
                    NULL}),
    HOMEKIT_ACCESSORY(.id = 7, .category = homekit_accessory_category_sensor,
                      .services =
                          (homekit_service_t *[]){
                              HOMEKIT_SERVICE(
                                  ACCESSORY_INFORMATION,
