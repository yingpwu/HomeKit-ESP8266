...
/**
 Defines information about a certain accessory, including a action to identify
 the accessory.
...
/**
 Defines a number of additional settings, rules and information on a lock
 mechanism inside of a accessory.
...
/**
 Defines that the accessory constains a lock mechanism. This can be combined
...
/**
 Defines that the accessory contains a stateless programmable switch, also
 called a button.
...
/**
 Defines that the accessory constains a window covering such as a blind or
 curtain.
...
/**
 Defines that the accessory allows for the management of a RTP (video) stream.
 This is mostly used for video doorbells and cameras and may not work
 standalone.
...
/**
 Defines that the accessory contains a microphone. This is mostly used for video
 doorbells and cameras and may not work standalone.
...
/**
 Defines that the accessory contains a speaker. This is mostly used for video
 doorbells and cameras and may not work standalone.
...
/**
 Defines that the accessory contains a doorbell. This is mostly used for video
 doorbells and may not work standalone.
...
/**
 Defines that the accessory contains a fan that implements version 2 of the fan
 features.
...
/**
 Defines that the accessory contains a filter that can notify the user of
 needing maintenace.
...
/**
 Describes the service label scheme of the accessory. See the official HAP
...
// Required Characteristics
// ”9.113 Target Control Supported Configuration” (page 224)
// ”9.114 Target Control List” (page 225)
#define HOMEKIT_SERVICE_TARGET_CONTROL_MANAGEMENT HOMEKIT_APPLE_UUID3("122")

// Required Characteristics
// ”9.4 Active Identifier” (page 159)
// ”9.3 Active” (page 159)
// ”9.12 Button Event” (page 163)

// Optional Characteristics ”9.62 Name” (page 188)
#define HOMEKIT_SERVICE_TARGET_CONTROL HOMEKIT_APPLE_UUID3("125")
// MARK: - Characteristics

#define HOMEKIT_CHARACTERISTIC_SUPPORTED_CONFIGURATION \
  HOMEKIT_APPLE_UUID1("123")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_CONTROL_SUPPORTED_CONFIGURATION( \
    _value, ...)                                                               \
  .type = HOMEKIT_CHARACTERISTIC_SUPPORTED_CONFIGURATION,                      \
  .description = "supported-target-configuration",                             \
  .format = homekit_format_tlv,                                                \
  .permissions = homekit_permissions_paired_read,                              \
  .value = HOMEKIT_TLV_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_TARGET_CONTROL_LIST HOMEKIT_APPLE_UUID1("124")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_CONTROL_LIST(_value, ...) \
  .type = HOMEKIT_CHARACTERISTIC_SUPPORTED_CONFIGURATION,               \
  .description = "TARGET_CONTROL_LIST", .format = homekit_format_tlv,   \
  .permissions = homekit_permissions_paired_read |                      \
                 homekit_permissions_paired_write |                     \
                 homekit_permissions_notify,                            \
  .value = HOMEKIT_TLV_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_BUTTON_EVENT HOMEKIT_APPLE_UUID1("126")
#define HOMEKIT_DECLARE_CHARACTERISTIC_BUTTON_EVENT(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_BUTTON_EVENT, .description = "BUTTON_EVENT",  \
  .format = homekit_format_tlv,                                                \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .value = HOMEKIT_TLV_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_ADMINISTRATOR_ONLY_ACCESS \
  HOMEKIT_APPLE_UUID1("1")
#define HOMEKIT_DECLARE_CHARACTERISTIC_ADMINISTRATOR_ONLY_ACCESS(_value, ...) \
  ...
  .description = "Administrator Only Access", .format = homekit_format_bool,  \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_AUDIO_FEEDBACK(_value, ...) \
  ...
  .description = "Audio Feedback", .format = homekit_format_bool,  \
  .permissions = homekit_permissions_paired_read |                 \
                 homekit_permissions_paired_write |                \
                 homekit_permissions_notify,                       \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_BRIGHTNESS(_value, ...)            \
  .type = HOMEKIT_CHARACTERISTIC_BRIGHTNESS, .description = "Brightness", \
  .format = homekit_format_int,                                           \
  .permissions = homekit_permissions_paired_read |                        \
                 homekit_permissions_paired_write |                       \
                 homekit_permissions_notify,                              \
  .unit = homekit_unit_percentage, .min_value = (float[]){0},             \
  .max_value = (float[]){100}, .min_step = (float[]){1},                  \
  .value = HOMEKIT_INT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_COOLING_THRESHOLD_TEMPERATURE \
  HOMEKIT_APPLE_UUID1("D")
#define HOMEKIT_DECLARE_CHARACTERISTIC_COOLING_THRESHOLD_TEMPERATURE(_value, \
  ...
  .format = homekit_format_float, .unit = homekit_unit_celsius,              \
  .permissions = homekit_permissions_paired_read |                           \
                 homekit_permissions_paired_write |                          \
                 homekit_permissions_notify,                                 \
  .min_value = (float[]){10}, .max_value = (float[]){35},                    \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_DOOR_STATE(_value, ...)         \
  ...
  .description = "Current Door State", .format = homekit_format_uint8,         \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){4},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
      {                                                                        \
          .count = 5,                                                          \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_HEATING_COOLING_STATE \
  HOMEKIT_APPLE_UUID1("F")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_HEATING_COOLING_STATE(_value,   \
  ...
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
      {                                                                        \
          .count = 3,                                                          \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_RELATIVE_HUMIDITY \
  HOMEKIT_APPLE_UUID2("10")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_RELATIVE_HUMIDITY(_value, ...)  \
  ...
  .description = "Current Relative Humidity", .format = homekit_format_float,  \
  .unit = homekit_unit_percentage,                                             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .min_step = (float[]){1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_TEMPERATURE(_value, ...)        \
  ...
  .description = "Current Temperature", .format = homekit_format_float,        \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_FIRMWARE_REVISION(revision, ...) \
  ...
  .description = "Firmware Revision", .format = homekit_format_string,  \
  .permissions = homekit_permissions_paired_read,                       \
  .value = HOMEKIT_STRING_(revision), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_HARDWARE_REVISION(revision, ...) \
  ...
  .description = "Hardware Revision", .format = homekit_format_string,  \
  .permissions = homekit_permissions_paired_read,                       \
  .value = HOMEKIT_STRING_(revision), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_HEATING_THRESHOLD_TEMPERATURE \
  HOMEKIT_APPLE_UUID2("12")
#define HOMEKIT_DECLARE_CHARACTERISTIC_HEATING_THRESHOLD_TEMPERATURE(_value, \
  ...
  .permissions = homekit_permissions_paired_read |                           \
                 homekit_permissions_paired_write |                          \
                 homekit_permissions_notify,                                 \
  .min_value = (float[]){0}, .max_value = (float[]){25},                     \
  .min_step = (float[]){0.1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_HUE HOMEKIT_APPLE_UUID2("13")
#define HOMEKIT_DECLARE_CHARACTERISTIC_HUE(_value, ...)            \
  .type = HOMEKIT_CHARACTERISTIC_HUE, .description = "Hue",        \
  .format = homekit_format_float, .unit = homekit_unit_arcdegrees, \
  .permissions = homekit_permissions_paired_read |                 \
                 homekit_permissions_paired_write |                \
                 homekit_permissions_notify,                       \
  .min_value = (float[]){0}, .max_value = (float[]){360},          \
  .min_step = (float[]){1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_IDENTIFY HOMEKIT_APPLE_UUID2("14")
#define HOMEKIT_DECLARE_CHARACTERISTIC_IDENTIFY(callback, ...)                \
  .type = HOMEKIT_CHARACTERISTIC_IDENTIFY, .format = homekit_format_bool,     \
  .permissions = homekit_permissions_paired_write, .description = "Identify", \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_CONTROL_POINT(...)       \
  ...
  .description = "Lock Control Point", .format = homekit_format_tlv, \
  .permissions = homekit_permissions_paired_write, ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_CURRENT_STATE(_value, ...)         \
  ...
  .description = "Lock Current State", .format = homekit_format_uint8,         \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){3},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
      {                                                                        \
          .count = 4,                                                          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_LAST_KNOWN_ACTION(_value, ...)     \
  ...
  .description = "Lock Last Known Action", .format = homekit_format_uint8,     \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){8},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
      {                                                                        \
          .count = 9,                                                          \
...
#define HOMEKIT_CHARACTERISTIC_LOCK_MANAGEMENT_AUTO_SECURITY_TIMEOUT \
  HOMEKIT_APPLE_UUID2("1A")
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_MANAGEMENT_AUTO_SECURITY_TIMEOUT( \
    _value, ...)                                                              \
  .type = HOMEKIT_CHARACTERISTIC_LOCK_MANAGEMENT_AUTO_SECURITY_TIMEOUT,       \
  .description = "Lock Management Auto Security Timeout",                     \
  .format = homekit_format_uint32, .unit = homekit_unit_seconds,              \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_TARGET_STATE(_value, ...) \
  ...
  .description = "Lock Target State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                    \
                 homekit_permissions_paired_write |                   \
                 homekit_permissions_notify,                          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOGS(...)                               \
  .type = HOMEKIT_CHARACTERISTIC_LOGS, .description = "Logs",                  \
  .format = homekit_format_tlv,                                                \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_MANUFACTURER(manufacturer, ...)        \
  .type = HOMEKIT_CHARACTERISTIC_MANUFACTURER, .description = "Manufacturer", \
  .format = homekit_format_string,                                            \
  .permissions = homekit_permissions_paired_read,                             \
  .value = HOMEKIT_STRING_(manufacturer), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_MODEL HOMEKIT_APPLE_UUID2("21")
#define HOMEKIT_DECLARE_CHARACTERISTIC_MODEL(model, ...)        \
  .type = HOMEKIT_CHARACTERISTIC_MODEL, .description = "Model", \
  .format = homekit_format_string,                              \
  .permissions = homekit_permissions_paired_read,               \
  .value = HOMEKIT_STRING_(model), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_MOTION_DETECTED(_value, ...)            \
  ...
  .description = "Motion Detected", .format = homekit_format_bool,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_NAME HOMEKIT_APPLE_UUID2("23")
#define HOMEKIT_DECLARE_CHARACTERISTIC_NAME(name, ...)        \
  .type = HOMEKIT_CHARACTERISTIC_NAME, .description = "Name", \
  .format = homekit_format_string,                            \
  .permissions = homekit_permissions_paired_read,             \
  .value = HOMEKIT_STRING_(name), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_OBSTRUCTION_DETECTED(_value, ...)       \
  ...
  .description = "Obstruction Detected", .format = homekit_format_bool,        \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_ON HOMEKIT_APPLE_UUID2("25")
#define HOMEKIT_DECLARE_CHARACTERISTIC_ON(_value, ...)    \
  .type = HOMEKIT_CHARACTERISTIC_ON, .description = "On", \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_OUTLET_IN_USE(_value, ...)              \
  ...
  .description = "Outlet In Use", .format = homekit_format_bool,               \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_ROTATION_DIRECTION(_value, ...) \
  ...
  .description = "Rotation Direction", .format = homekit_format_int,   \
  .permissions = homekit_permissions_paired_read |                     \
                 homekit_permissions_paired_write |                    \
                 homekit_permissions_notify,                           \
  .min_value = (float[]){0}, .max_value = (float[]){1},                \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_ROTATION_SPEED(_value, ...) \
  ...
  .description = "Rotation Speed", .format = homekit_format_float, \
  .unit = homekit_unit_percentage,                                 \
  .permissions = homekit_permissions_paired_read |                 \
                 homekit_permissions_paired_write |                \
                 homekit_permissions_notify,                       \
  .min_value = (float[]){0}, .max_value = (float[]){100},          \
  .min_step = (float[]){1}, ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_SATURATION HOMEKIT_APPLE_UUID2("2F")
#define HOMEKIT_DECLARE_CHARACTERISTIC_SATURATION(_value, ...)            \
  .type = HOMEKIT_CHARACTERISTIC_SATURATION, .description = "Saturation", \
  .format = homekit_format_float, .unit = homekit_unit_percentage,        \
  .permissions = homekit_permissions_paired_read |                        \
                 homekit_permissions_paired_write |                       \
                 homekit_permissions_notify,                              \
  .min_value = (float[]){0}, .max_value = (float[]){100},                 \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SERIAL_NUMBER(serial, ...)  \
  ...
  .description = "Serial Number", .format = homekit_format_string, \
  .permissions = homekit_permissions_paired_read,                  \
  .value = HOMEKIT_STRING_(serial), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_DOOR_STATE(_value, ...) \
  ...
  .description = "Target Door State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                    \
                 homekit_permissions_paired_write |                   \
                 homekit_permissions_notify,                          \
  .min_value = (float[]){0}, .max_value = (float[]){1},               \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_HEATING_COOLING_STATE \
  HOMEKIT_APPLE_UUID2("33")
...
#define HOMEKIT_CHARACTERISTIC_TARGET_RELATIVE_HUMIDITY \
  HOMEKIT_APPLE_UUID2("34")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_RELATIVE_HUMIDITY(_value, ...) \
  ...
  .description = "Target Relative Humidity", .format = homekit_format_float, \
  .unit = homekit_unit_percentage,                                           \
  .permissions = homekit_permissions_paired_read |                           \
                 homekit_permissions_paired_write |                          \
                 homekit_permissions_notify,                                 \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_TEMPERATURE(_value, ...) \
  ...
  .description = "Target Temperature", .format = homekit_format_float, \
  .unit = homekit_unit_celsius,                                        \
  .permissions = homekit_permissions_paired_read |                     \
                 homekit_permissions_paired_write |                    \
                 homekit_permissions_notify,                           \
  .min_value = (float[]){10}, .max_value = (float[]){38},              \
  .min_step = (float[]){0.1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_TEMPERATURE_DISPLAY_UNITS \
  HOMEKIT_APPLE_UUID2("36")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TEMPERATURE_DISPLAY_UNITS(_value, ...) \
  ...
  .description = "Temperature Display Units", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
  .min_value = (float[]){0}, .max_value = (float[]){1},                       \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VERSION(_value, ...)         \
  .type = HOMEKIT_CHARACTERISTIC_VERSION, .description = "Version", \
  .format = homekit_format_string,                                  \
  .permissions = homekit_permissions_paired_read,                   \
  .value = HOMEKIT_STRING_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_AIR_PARTICULATE_DENSITY(_value, ...)    \
  ...
  .description = "Air Particulate Density", .format = homekit_format_float,    \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_AIR_PARTICULATE_SIZE(_value, ...)       \
  ...
  .description = "Air Particulate Size", .format = homekit_format_uint8,       \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_CHARACTERISTIC_SECURITY_SYSTEM_CURRENT_STATE \
  HOMEKIT_APPLE_UUID2("66")
...
#define HOMEKIT_CHARACTERISTIC_SECURITY_SYSTEM_TARGET_STATE \
  HOMEKIT_APPLE_UUID2("67")
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_BATTERY_LEVEL(_value, ...)              \
  ...
  .description = "Battery Level", .format = homekit_format_uint8,              \
  .unit = homekit_unit_percentage,                                             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .min_step = (float[]){1}, .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CONTACT_SENSOR_STATE(_value, ...)       \
  ...
  .description = "Contact Sensor State", .format = homekit_format_uint8,       \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_AMBIENT_LIGHT_LEVEL \
  HOMEKIT_APPLE_UUID2("6B")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_AMBIENT_LIGHT_LEVEL(_value,     \
  ...
  .format = homekit_format_float, .unit = homekit_unit_lux,                    \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0.0001}, .max_value = (float[]){100000},              \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_CURRENT_HORIZONTAL_TILT_ANGLE \
  HOMEKIT_APPLE_UUID2("6C")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_HORIZONTAL_TILT_ANGLE(_value,   \
  ...
  .format = homekit_format_int, .unit = homekit_unit_arcdegrees,               \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){-90}, .max_value = (float[]){90},                     \
  .min_step = (float[]){1}, .value = HOMEKIT_INT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_POSITION(_value, ...)           \
  ...
  .description = "Current Position", .format = homekit_format_uint8,           \
  .unit = homekit_unit_percentage,                                             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .min_step = (float[]){1}, .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_CURRENT_VERTICAL_TILT_ANGLE \
  HOMEKIT_APPLE_UUID2("6E")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_VERTICAL_TILT_ANGLE(_value,     \
  ...
  .description = "Current Vertical Tilt Angle", .format = homekit_format_int,  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_HOLD_POSITION(_value, ...) \
  ...
  .description = "Hold Position", .format = homekit_format_bool,  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LEAK_DETECTED(_value, ...)              \
  ...
  .description = "Leak Detected", .format = homekit_format_uint8,              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_OCCUPANCY_DETECTED(_value, ...)         \
  ...
  .description = "Occupancy Detected", .format = homekit_format_uint8,         \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_POSITION_STATE(_value, ...)             \
  ...
  .description = "Position State", .format = homekit_format_uint8,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_CHARACTERISTIC_PROGRAMMABLE_SWITCH_EVENT \
  HOMEKIT_APPLE_UUID2("73")
#define HOMEKIT_DECLARE_CHARACTERISTIC_PROGRAMMABLE_SWITCH_EVENT(_value, ...)  \
  ...
  .description = "Programmable Switch Event", .format = homekit_format_uint8,  \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STATUS_ACTIVE(_value, ...)              \
  ...
  .description = "Status Active", .format = homekit_format_bool,               \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SMOKE_DETECTED(_value, ...)             \
  ...
  .description = "Smoke Detected", .format = homekit_format_uint8,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STATUS_FAULT(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_STATUS_FAULT, .description = "Status Fault",  \
  .format = homekit_format_uint8,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STATUS_JAMMED(_value, ...)              \
  ...
  .description = "Status Jammed", .format = homekit_format_uint8,              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STATUS_LOW_BATTERY(_value, ...)         \
  ...
  .description = "Status Low Battery", .format = homekit_format_uint8,         \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STATUS_TAMPERED(_value, ...)            \
  ...
  .description = "Status Tampered", .format = homekit_format_uint8,            \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_HORIZONTAL_TILT_ANGLE \
  HOMEKIT_APPLE_UUID2("7B")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_HORIZONTAL_TILT_ANGLE(_value,    \
  ...
  .description = "Target Horizontal Tilt Angle", .format = homekit_format_int, \
  .unit = homekit_unit_arcdegrees,                                             \
  .permissions = homekit_permissions_paired_read |                             \
                 homekit_permissions_paired_write |                            \
                 homekit_permissions_notify,                                   \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_POSITION(_value, ...) \
  ...
  .description = "Target Position", .format = homekit_format_uint8, \
  .unit = homekit_unit_percentage,                                  \
  .permissions = homekit_permissions_paired_read |                  \
                 homekit_permissions_paired_write |                 \
                 homekit_permissions_notify,                        \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_VERTICAL_TILT_ANGLE \
  HOMEKIT_APPLE_UUID2("7D")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_VERTICAL_TILT_ANGLE(_value, ...) \
  ...
  .description = "Target Vertical Tilt Angle", .format = homekit_format_int,   \
  .unit = homekit_unit_arcdegrees,                                             \
  .permissions = homekit_permissions_paired_read |                             \
                 homekit_permissions_paired_write |                            \
                 homekit_permissions_notify,                                   \
...
#define HOMEKIT_CHARACTERISTIC_SECURITY_SYSTEM_ALARM_TYPE \
  HOMEKIT_APPLE_UUID2("8E")
#define HOMEKIT_DECLARE_CHARACTERISTIC_SECURITY_SYSTEM_ALARM_TYPE(_value, ...) \
  ...
  .description = "Security System Alarm Type", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1}, .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CHARGING_STATE(_value, ...)             \
  ...
  .description = "Charging State", .format = homekit_format_uint8,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_CHARACTERISTIC_CARBON_MONOXIDE_DETECTED \
  HOMEKIT_APPLE_UUID2("69")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_MONOXIDE_DETECTED(_value, ...)   \
  ...
  .description = "Carbon Monoxide Detected", .format = homekit_format_uint8,   \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_MONOXIDE_LEVEL(_value, ...)      \
  ...
  .description = "Carbon Monoxide Level", .format = homekit_format_float,      \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_CARBON_MONOXIDE_PEAK_LEVEL \
  HOMEKIT_APPLE_UUID2("91")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_MONOXIDE_PEAK_LEVEL(_value, ...) \
  ...
  .description = "Carbon Monoxide Peak Level", .format = homekit_format_float, \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_DIOXIDE_DETECTED(_value, ...)    \
  ...
  .description = "Carbon Dioxide Detected", .format = homekit_format_uint8,    \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_DIOXIDE_LEVEL(_value, ...)       \
  ...
  .description = "Carbon Dioxide Level", .format = homekit_format_float,       \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100000},                   \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_CARBON_DIOXIDE_PEAK_LEVEL \
  HOMEKIT_APPLE_UUID2("94")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CARBON_DIOXIDE_PEAK_LEVEL(_value, ...)  \
  ...
  .description = "Carbon Dioxide Peak Level", .format = homekit_format_float,  \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100000},                   \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_AIR_QUALITY(_value, ...)                \
  .type = HOMEKIT_CHARACTERISTIC_AIR_QUALITY, .description = "Air Quality",    \
  .format = homekit_format_uint8,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){5},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
      {                                                                        \
          .count = 6,                                                          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_STREAMING_STATUS(...)                   \
  ...
  .description = "Streaming Status", .format = homekit_format_tlv,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_SUPPORTED_VIDEO_STREAM_CONFIGURATION \
  HOMEKIT_APPLE_UUID3("114")
#define HOMEKIT_DECLARE_CHARACTERISTIC_SUPPORTED_VIDEO_STREAM_CONFIGURATION( \
  ...
  .format = homekit_format_tlv,                                              \
  .permissions = homekit_permissions_paired_read, ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_SUPPORTED_AUDIO_STREAM_CONFIGURATION \
  HOMEKIT_APPLE_UUID3("115")
...
#define HOMEKIT_CHARACTERISTIC_SUPPORTED_RTP_CONFIGURATION \
  HOMEKIT_APPLE_UUID3("116")
#define HOMEKIT_DECLARE_CHARACTERISTIC_SUPPORTED_RTP_CONFIGURATION(...)       \
  .type = HOMEKIT_CHARACTERISTIC_SUPPORTED_RTP_CONFIGURATION,                 \
  .description = "Supported RTP Configuration", .format = homekit_format_tlv, \
  .permissions = homekit_permissions_paired_read, ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SETUP_ENDPOINTS(...)               \
  ...
  .description = "Setup Endpoints", .format = homekit_format_tlv,         \
  .permissions =                                                          \
      homekit_permissions_paired_read | homekit_permissions_paired_write, \
  ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_SELECTED_RTP_STREAM_CONFIGURATION \
  HOMEKIT_APPLE_UUID3("117")
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VOLUME(_value, ...)         \
  .type = HOMEKIT_CHARACTERISTIC_VOLUME, .description = "Volume",  \
  .format = homekit_format_uint8, .unit = homekit_unit_percentage, \
  .permissions = homekit_permissions_paired_read |                 \
                 homekit_permissions_paired_write |                \
                 homekit_permissions_notify,                       \
  .min_value = (float[]){0}, .max_value = (float[]){100},          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_MUTE(_value, ...)      \
  .type = HOMEKIT_CHARACTERISTIC_MUTE, .description = "Mute", \
  .format = homekit_format_bool,                              \
  .permissions = homekit_permissions_paired_read |            \
                 homekit_permissions_paired_write |           \
                 homekit_permissions_notify,                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_NIGHT_VISION(_value, ...)              \
  .type = HOMEKIT_CHARACTERISTIC_NIGHT_VISION, .description = "Night Vision", \
  .format = homekit_format_bool,                                              \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_OPTICAL_ZOOM(_value, ...)              \
  .type = HOMEKIT_CHARACTERISTIC_OPTICAL_ZOOM, .description = "Optical Zoom", \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_DIGITAL_ZOOM(_value, ...)              \
  .type = HOMEKIT_CHARACTERISTIC_DIGITAL_ZOOM, .description = "Digital Zoom", \
  .format = homekit_format_float,                                             \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_IMAGE_ROTATION(_value, ...) \
  ...
  .description = "Image Rotation", .format = homekit_format_float, \
  .permissions = homekit_permissions_paired_read |                 \
                 homekit_permissions_paired_write |                \
                 homekit_permissions_notify,                       \
  .valid_values =                                                  \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_IMAGE_MIRRORING(_value, ...) \
  ...
  .description = "Image Mirroring", .format = homekit_format_bool,  \
  .permissions = homekit_permissions_paired_read |                  \
                 homekit_permissions_paired_write |                 \
                 homekit_permissions_notify,                        \
  .value = HOMEKIT_BOOL_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_ACCESSORY_FLAGS(_value, ...)            \
  ...
  .description = "Accessory Flags", .format = homekit_format_uint32,           \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .valid_values =                                                              \
      {                                                                        \
          .count = 2,                                                          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_LOCK_PHYSICAL_CONTROLS(_value, ...) \
  ...
  .description = "Lock Physical Controls", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                         \
                 homekit_permissions_paired_write |                        \
                 homekit_permissions_notify,                               \
  .min_value = (float[]){0}, .max_value = (float[]){1},                    \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_AIR_PURIFIER_STATE \
  HOMEKIT_APPLE_UUID2("A9")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_AIR_PURIFIER_STATE(_value, ...) \
  ...
  .description = "Current Air Purifier State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_SLAT_STATE(_value, ...)         \
  ...
  .description = "Current Slat State", .format = homekit_format_uint8,         \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SLAT_TYPE(_value, ...)                \
  .type = HOMEKIT_CHARACTERISTIC_SLAT_TYPE, .description = "Slat Type",      \
  .format = homekit_format_uint8,                                            \
  .permissions = homekit_permissions_paired_read, .min_value = (float[]){0}, \
  .max_value = (float[]){1}, .min_step = (float[]){1},                       \
  .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_FILTER_LIFE_LEVEL(_value, ...)          \
  ...
  .description = "Filter Life Level", .format = homekit_format_float,          \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .min_step = (float[]){1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_FILTER_CHANGE_INDICATION \
  HOMEKIT_APPLE_UUID2("AC")
#define HOMEKIT_DECLARE_CHARACTERISTIC_FILTER_CHANGE_INDICATION(_value, ...)   \
  ...
  .description = "Filter Change Indication", .format = homekit_format_uint8,   \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_RESET_FILTER_INDICATION(_value, ...) \
  ...
  .description = "Reset Filter Indication", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                          \
                 homekit_permissions_paired_write |                         \
                 homekit_permissions_notify,                                \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_AIR_PURIFIER_STATE \
  HOMEKIT_APPLE_UUID2("A8")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_AIR_PURIFIER_STATE(_value, ...) \
  ...
  .description = "Target Air Purifier State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                            \
                 homekit_permissions_paired_write |                           \
                 homekit_permissions_notify,                                  \
  .min_value = (float[]){0}, .max_value = (float[]){1},                       \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_FAN_STATE(_value, ...) \
  ...
  .description = "Target Fan State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                   \
                 homekit_permissions_paired_write |                  \
                 homekit_permissions_notify,                         \
  .min_value = (float[]){0}, .max_value = (float[]){1},              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_FAN_STATE(_value, ...)          \
  ...
  .description = "Current Fan State", .format = homekit_format_uint8,          \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
  .valid_values =                                                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_ACTIVE(_value, ...)        \
  .type = HOMEKIT_CHARACTERISTIC_ACTIVE, .description = "Active", \
  .format = homekit_format_uint8,                                 \
  .permissions = homekit_permissions_paired_read |                \
                 homekit_permissions_paired_write |               \
                 homekit_permissions_notify,                      \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SWING_MODE(_value, ...)            \
  .type = HOMEKIT_CHARACTERISTIC_SWING_MODE, .description = "Swing Mode", \
  .format = homekit_format_uint8,                                         \
  .permissions = homekit_permissions_paired_read |                        \
                 homekit_permissions_paired_write |                       \
                 homekit_permissions_notify,                              \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_TILT_ANGLE(_value, ...)         \
  ...
  .description = "Current Tilt Angle", .format = homekit_format_int,           \
  .unit = homekit_unit_arcdegrees,                                             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){-90}, .max_value = (float[]){90},                     \
  .min_step = (float[]){1}, .value = HOMEKIT_INT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_TILT_ANGLE(_value, ...) \
  ...
  .description = "Target Tilt Angle", .format = homekit_format_int,   \
  .unit = homekit_unit_arcdegrees,                                    \
  .permissions = homekit_permissions_paired_read |                    \
                 homekit_permissions_paired_write |                   \
                 homekit_permissions_notify,                          \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_OZONE_DENSITY(_value, ...)              \
  ...
  .description = "Ozone Density", .format = homekit_format_float,              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_NITROGEN_DIOXIDE_DENSITY \
  HOMEKIT_APPLE_UUID2("C4")
#define HOMEKIT_DECLARE_CHARACTERISTIC_NITROGEN_DIOXIDE_DENSITY(_value, ...)   \
  ...
  .description = "Nitrogen Dioxide Density", .format = homekit_format_float,   \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SULPHUR_DIOXIDE_DENSITY(_value, ...)    \
  ...
  .description = "Sulphur Dioxide Density", .format = homekit_format_float,    \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_PM25_DENSITY(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_PM25_DENSITY, .description = "PM25 Density",  \
  .format = homekit_format_float,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_PM10_DENSITY(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_PM10_DENSITY, .description = "PM10 Density",  \
  .format = homekit_format_float,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VOC_DENSITY(_value, ...)                \
  .type = HOMEKIT_CHARACTERISTIC_VOC_DENSITY, .description = "VOC Density",    \
  .format = homekit_format_float,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1000},                     \
  .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SERVICE_LABEL_INDEX(_value, ...)      \
  ...
  .description = "Service Label Index", .format = homekit_format_uint8,      \
  .permissions = homekit_permissions_paired_read, .min_value = (float[]){1}, \
  .min_step = (float[]){1}, .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SERVICE_LABEL_NAMESPACE(_value, ...)  \
  ...
  .description = "Service Label Namespace", .format = homekit_format_uint8,  \
  .permissions = homekit_permissions_paired_read, .min_value = (float[]){0}, \
  .max_value = (float[]){1}, .min_step = (float[]){1},                       \
  .valid_values =                                                            \
      {                                                                      \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_COLOR_TEMPERATURE(_value, ...)  \
  ...
  .description = "Color Temperature", .format = homekit_format_uint32, \
  .permissions = homekit_permissions_paired_read |                     \
                 homekit_permissions_paired_write |                    \
                 homekit_permissions_notify,                           \
  .min_value = (float[]){50}, .max_value = (float[]){400},             \
  .min_step = (float[]){1}, .value = HOMEKIT_UINT32_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_IN_USE HOMEKIT_APPLE_UUID2("D2")
#define HOMEKIT_DECLARE_CHARACTERISTIC_IN_USE(_value, ...)                     \
  .type = HOMEKIT_CHARACTERISTIC_IN_USE, .description = "In Use",              \
  .format = homekit_format_uint8,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .min_step = (float[]){1},                                                    \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_IS_CONFIGURED(_value, ...) \
  ...
  .description = "Is Configured", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                \
                 homekit_permissions_paired_write |               \
                 homekit_permissions_notify,                      \
  .min_value = (float[]){0}, .max_value = (float[]){1},           \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_PROGRAM_MODE(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_PROGRAM_MODE, .description = "Program Mode",  \
  .format = homekit_format_uint8,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
  .min_step = (float[]){1},                                                    \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_REMAINING_DURATION(_value, ...)         \
  ...
  .description = "Remaining Duration", .format = homekit_format_uint32,        \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VALVE_TYPE(_value, ...)                 \
  .type = HOMEKIT_CHARACTERISTIC_VALVE_TYPE, .description = "Valve Type",      \
  .format = homekit_format_uint8,                                              \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){3},                        \
  .min_step = (float[]){1},                                                    \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_HEATER_COOLER_STATE \
  HOMEKIT_APPLE_UUID2("B1")
...
#define HOMEKIT_CHARACTERISTIC_TARGET_HEATER_COOLER_STATE \
  HOMEKIT_APPLE_UUID2("B2")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_HEATER_COOLER_STATE(_value, ...) \
  ...
  .description = "Target Heater Cooler State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                             \
                 homekit_permissions_paired_write |                            \
                 homekit_permissions_notify,                                   \
  .min_value = (float[]){0}, .max_value = (float[]){2},                        \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_HUMIDIFIER_DEHUMIDIFIER_STATE \
  HOMEKIT_APPLE_UUID2("B3")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_HUMIDIFIER_DEHUMIDIFIER_STATE(  \
    _value, ...)                                                               \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_HUMIDIFIER_DEHUMIDIFIER_STATE \
  HOMEKIT_APPLE_UUID2("B4")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_HUMIDIFIER_DEHUMIDIFIER_STATE( \
    _value, ...)                                                             \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_WATER_LEVEL(_value, ...)                \
  .type = HOMEKIT_CHARACTERISTIC_WATER_LEVEL, .description = "Water Level",    \
  .format = homekit_format_float, .unit = homekit_unit_percentage,             \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){100},                      \
  .min_step = (float[]){1}, .value = HOMEKIT_FLOAT_(_value), ##__VA_ARGS__

#define HOMEKIT_CHARACTERISTIC_RELATIVE_HUMIDITY_DEHUMIDIFIER_THRESHOLD \
  HOMEKIT_APPLE_UUID2("C9")
#define HOMEKIT_DECLARE_CHARACTERISTIC_RELATIVE_HUMIDITY_DEHUMIDIFIER_THRESHOLD( \
    _value, ...)                                                                 \
...
#define HOMEKIT_CHARACTERISTIC_RELATIVE_HUMIDITY_HUMIDIFIER_THRESHOLD \
  HOMEKIT_APPLE_UUID2("CA")
#define HOMEKIT_DECLARE_CHARACTERISTIC_RELATIVE_HUMIDITY_HUMIDIFIER_THRESHOLD( \
    _value, ...)                                                               \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_ACTIVE_IDENTIFIER(_value, ...)  \
  ...
  .description = "Active Identifier", .format = homekit_format_uint32, \
  .permissions = homekit_permissions_paired_read |                     \
                 homekit_permissions_paired_write |                    \
                 homekit_permissions_notify,                           \
  .value = HOMEKIT_UINT32_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CONFIGURED_NAME(_value, ...)  \
  ...
  .description = "Configured Name", .format = homekit_format_string, \
  .permissions = homekit_permissions_paired_read |                   \
                 homekit_permissions_paired_write |                  \
                 homekit_permissions_notify,                         \
  .value = HOMEKIT_STRING_(_value, .is_static = true), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_SLEEP_DISCOVERY_MODE(_value, ...)       \
  ...
  .description = "Sleep Discovery Mode", .format = homekit_format_uint8,       \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){1},                        \
  .valid_values =                                                              \
      {                                                                        \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CLOSED_CAPTIONS(_value, ...) \
  ...
  .description = "Closed Captions", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                  \
                 homekit_permissions_paired_write |                 \
                 homekit_permissions_notify,                        \
  .min_value = (float[]){0}, .max_value = (float[]){1},             \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_DISPLAY_ORDER(_value, ...) \
  ...
  .description = "Display Order", .format = homekit_format_tlv,   \
  .permissions = homekit_permissions_paired_read |                \
                 homekit_permissions_paired_write |               \
                 homekit_permissions_notify,                      \
  .value = HOMEKIT_UINT8_(_value), ##__VA_ARGS__
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_MEDIA_STATE(_value, ...)        \
  ...
  .description = "Current Media State", .format = homekit_format_uint8,        \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){3},                        \
  .valid_values =                                                              \
      {                                                                        \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_MEDIA_STATE(_value, ...) \
  ...
  .description = "Target Media State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                     \
                 homekit_permissions_paired_write |                    \
                 homekit_permissions_notify,                           \
  .min_value = (float[]){0}, .max_value = (float[]){2},                \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_PICTURE_MODE(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_PICTURE_MODE, .description = "Picture Mode",  \
  .format = homekit_format_uint16,                                             \
  .permissions = homekit_permissions_paired_read |                             \
                 homekit_permissions_paired_write |                            \
                 homekit_permissions_notify,                                   \
  .min_value = (float[]){0}, .max_value = (float[]){13},                       \
  .valid_values =                                                              \
      {                                                                        \
          .count = 14,                                                         \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_POWER_MODE_SELECTION(...)              \
  ...
  .description = "Power Mode Selection", .format = homekit_format_uint8,      \
  .permissions = homekit_permissions_paired_write, .min_value = (float[]){0}, \
  .max_value = (float[]){1},                                                  \
  .valid_values =                                                             \
      {                                                                       \
          .count = 2,                                                         \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_REMOTE_KEY(...)                        \
  .type = HOMEKIT_CHARACTERISTIC_REMOTE_KEY, .description = "Remote Key",     \
  .format = homekit_format_uint8,                                             \
  .permissions = homekit_permissions_paired_write, .min_value = (float[]){0}, \
  .max_value = (float[]){16},                                                 \
  .valid_values =                                                             \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_INPUT_SOURCE_TYPE(_value, ...)          \
  ...
  .description = "Input Source Type", .format = homekit_format_uint8,          \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){10},                       \
  .valid_values =                                                              \
      {                                                                        \
          .count = 11,                                                         \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_INPUT_DEVICE_TYPE(_value, ...)          \
  ...
  .description = "Input Device Type", .format = homekit_format_uint8,          \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){5},                        \
  .valid_values =                                                              \
      {                                                                        \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_IDENTIFIER(_value, ...)               \
  .type = HOMEKIT_CHARACTERISTIC_IDENTIFIER, .description = "Identifier",    \
...
#define HOMEKIT_CHARACTERISTIC_CURRENT_VISIBILITY_STATE \
  HOMEKIT_APPLE_UUID3("135")
#define HOMEKIT_DECLARE_CHARACTERISTIC_CURRENT_VISIBILITY_STATE(_value, ...)   \
  ...
  .description = "Current Visibility State", .format = homekit_format_uint8,   \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){3},                        \
  .valid_values =                                                              \
      {                                                                        \
...
#define HOMEKIT_CHARACTERISTIC_TARGET_VISIBILITY_STATE \
  HOMEKIT_APPLE_UUID3("134")
#define HOMEKIT_DECLARE_CHARACTERISTIC_TARGET_VISIBILITY_STATE(_value, ...) \
  .type = HOMEKIT_CHARACTERISTIC_TARGET_VISIBILITY_STATE,                   \
  .description = "Target Visibility State", .format = homekit_format_uint8, \
  .permissions = homekit_permissions_paired_read |                          \
                 homekit_permissions_paired_write |                         \
                 homekit_permissions_notify,                                \
  .min_value = (float[]){0}, .max_value = (float[]){1},                     \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VOLUME_CONTROL_TYPE(_value, ...)        \
  ...
  .description = "Volume Control Type", .format = homekit_format_uint8,        \
  .permissions = homekit_permissions_paired_read | homekit_permissions_notify, \
  .min_value = (float[]){0}, .max_value = (float[]){3},                        \
  .valid_values =                                                              \
      {                                                                        \
...
#define HOMEKIT_DECLARE_CHARACTERISTIC_VOLUME_SELECTOR(...)                   \
  ...
  .description = "Volume Selector", .format = homekit_format_uint8,           \
  .permissions = homekit_permissions_paired_write, .min_value = (float[]){0}, \
  .max_value = (float[]){1},                                                  \
  .valid_values =                                                             \
      {                                                                       \
